  ...
  return (
    <div className={styles.home}>
      ...
      <div className="container">
        <section className={styles.section} style={{ paddingTop: '80px', paddingBottom: '120px' }} onClick={handleSectionClick('newArrivals')}>
          <h2 className="section-title">New Arrivals</h2>
          <ProductGrid products={newArrivals} />
        </section>

        <section className={styles.section} style={{ paddingBottom: '120px' }} onClick={handleSectionClick('bestSellers')}>
          <h2 className="section-title">Best Sellers</h2>
          <ProductGrid products={topRated} />
        </section>

        <section className={styles.section} style={{ paddingBottom: '120px' }} onClick={handleSectionClick('educationalWonders')}>
          <h2 className="section-title">Educational Wonders</h2>
          <ProductGrid products={educational} />
        </section>

        <section className={styles.section} style={{ paddingBottom: '120px' }} onClick={handleSectionClick('outdoorAdventure')}>
